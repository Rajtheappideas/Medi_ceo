...
const ResultBoxDirectAfterNodeListOfSubcategory = () => {
  ...
  const onDragEnd = (result) => {
    ...
    dispatch(
      handleChangeOrderOfResultPageDirectAfterSubCategory(reorderedItems)
    );
  };
  ...
  return (
    <div className=" w-full no_scrollbar lg:max-h-[80vh] max-h-[150vh] overflow-y-scroll overflow-x-hidden flex items-start justify-start lg:p-5 p-3 mx-auto xl:flex-row flex-col gap-5">
      <div
        ...
        }  text-center lg:p-5 p-3 lg:space-y-5 md:space-y-3 space-y-2 mx-auto scrollbar lg:max-h-[80vh] max-h-[150vh] overflow-y-scroll overflow-x-hidden rounded-md border`}
      >
        {/* top div , your result */}
...
export default ResultBoxDirectAfterNodeListOfSubcategory;
