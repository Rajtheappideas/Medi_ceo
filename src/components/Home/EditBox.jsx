...
const data = [
  { value: 0, label: 'Field Title' },
  { value: 1, label: 'Title' },
  { value: 2, label: 'Result Or Node ID' },
  { value: 3, label: 'Filtered' },
]
  ...
  return (
    <div className="lg:w-1/2 flex items-start justify-start flex-col mx-auto rounded-lg shadow-md p-4 sm:w-full">
      ...
      <div className="w-full shadow-md p-4">
        <p className="w-full flex items-center justify-between my-1">
          Field Title
      ...
      <div className="my-3 w-full">
        <label htmlFor="message" className="block mb-2  font-medium text-gray-90">
          Title
        </label>
        <textarea
          id="message"
