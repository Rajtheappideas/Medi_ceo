  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="w-full 2xl:pt-[6vw] xl:pt-[5vw] pt-7 text-sm flex flex-col 2xl:min-h-[88vh] 2xl:max-h-[88vh] min-h-[85vh] max-h-[85vh] justify-between">
          <ul
            className={`w-full 2xl:space-y-[2vw] xl:space-y-[1.5vw] lg:space-y-5 ${
          ...
          <ul>
            ...
            >
              {openSidebar && (
                <p className="space-y-0 2xl:space-y-[0.6vw]">
